...
import com.gcstudios.entities.Enemy4;
import com.gcstudios.entities.Entity;
import com.gcstudios.entities.Fruit;
			...
			for(int xx = 0; xx < map.getWidth(); xx++){
				for(int yy = 0; yy < map.getHeight(); yy++){
					...
					if(pixelAtual == 0xFF000000){
						...
						Coin coin = new Coin(xx*16,yy*16,16,16,0,Entity.LittleCoin);
						Game.entities.add(coin);
						Player.totalScore+=10;
					}else if(pixelAtual == 0xFF00FF21) {	
						Fruit fruit = new Fruit(xx*16,yy*16,16,16,0,Entity.Fruit);
						Game.entities.add(fruit);
					}else if(pixelAtual == 0xFF00ECE8) {
						//Instanciar inimigo e adicionar a lista das entities
						Enemy enemy =  new Enemy(xx*16,yy*16,16,16,4,Entity.Ghost1);
						Game.entities.add(enemy);
					}else if(pixelAtual == 0xFFFF0000) {
						//Instanciar inimigo e adicionar a lista das entities
						Enemy2 enemy2 =  new Enemy2(xx*16,yy*16,16,16,1,Entity.Ghost2);
						Game.entities.add(enemy2);
					}else if(pixelAtual == 0xFFFFD800) {
						//Instanciar inimigo e adicionar a lista das entities
						Enemy3 enemy3 =  new Enemy3(xx*16,yy*16,16,16,1,Entity.Ghost3);
						Game.entities.add(enemy3);
					}else if(pixelAtual == 0xFFFF7FED) {
						//Instanciar inimigo e adicionar a lista das entities
						Enemy4 enemy4 =  new Enemy4(xx*16,yy*16,16,16,1,Entity.Ghost4);
