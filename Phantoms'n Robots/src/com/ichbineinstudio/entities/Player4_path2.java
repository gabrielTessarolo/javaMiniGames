...
public class Player4_path2 extends Entity{
	...
	public Player4_path2(int x, int y, int width, int height,double speed,BufferedImage sprite) {
	...
	public void render(Graphics g) {
		...
		if(isAtRight) {
			...
			if(isAttacking) {
				...
				g.drawImage(Entity.cannotSetTowerIcon, xTarget - 8, yTarget, 16, 16, null);
				
			if(timerCounter > timer - 20) {
				g.drawImage(explosion[explosionIndex], xTarget - 8, yTarget, 16, 16, null);
